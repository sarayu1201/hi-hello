...
def check():
    ...
    try:
        ...
        with urllib.request.urlopen(req) as response:
            ...
            # Find question 18 (index 17 or match id 18)
            q18 = None
            for q in questions:
                # Some APIs might use display_question_number or question_number or id
                if q.get("id") == 18 or q.get("question_number") == 18 or q.get("display_question_number") == 18:
                    q18 = q
                    break
                    
            if q18:
                print("\n--- LIVE QUESTION 18 DETAILS ---")
                print(f"ID:             {repr(q18.get('id'))}")
                ...
                print("Question 18 not found in the list.")
