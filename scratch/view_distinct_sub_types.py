...
def check():
    ...
    try:
        ...
        # Distinct sub_types containing "sbi"
        sub_types = questions_col.distinct("sub_type", {"sub_type": {"$regex": "sbi", "$options": "i"}})
        print("Distinct sub_types with SBI:")
        print(sub_types)
        
        # Distinct source_files containing "sbi"
        source_files = questions_col.distinct("source_file", {"source_file": {"$regex": "sbi", "$options": "i"}})
        print("\nDistinct source_files with SBI:")
        print(source_files)
